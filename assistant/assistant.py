...
def doctor(args):
    ...
    if args.model not in models:
        print(
            f"\n  Note: '{args.model}' is not in that list. "
            "Pass --model with one of the names above."
        )
...
def build_parser():
    ...
    parser.add_argument("--model", default=os.environ.get("GEMINI_MODEL", gemini.DEFAULT_MODEL))
