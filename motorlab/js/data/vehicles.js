...
const CATALOG = [
  V({ id:'hatch', name:'Volkswagen Golf GTI (Mk4)', maker:'Volkswagen', body:'hatch', engines:['i4-16-na','i4-20-t','i4-20-vtec','d-i4-20'],
  ...
  V({ id:'sedan', name:'Audi A6 (C7)', maker:'Audi', body:'sedan', drivetrain:'RWD', bay:'front-longitudinal',
  ...
  V({ id:'super', name:'Mercedes-AMG One', maker:'Mercedes-AMG', body:'super', drivetrain:'RWD', bay:'mid',
  ...
  V({ id:'awd-rally', name:'Toyota GR Yaris Rally1', maker:'Toyota', body:'rally', drivetrain:'AWD', bay:'front-transverse',
  ...
  V({ id:'pickup', name:'Ford F-150 Raptor', maker:'Ford', body:'pickup', drivetrain:'AWD', bay:'front-longitudinal',
  ...
  V({ id:'drift', name:'JDM drift coupe', maker:'Drift', body:'coupe', drivetrain:'RWD', bay:'front-longitudinal',
  ...
  V({ id:'formula', name:'Ferrari F1 (2019)', maker:'Ferrari', body:'formula', drivetrain:'RWD', bay:'mid',
  ...
  V({ id:'stockcar', name:'Late-model stock car', maker:'Stock car', body:'stockcar', drivetrain:'RWD', bay:'front-longitudinal',
  ...
  V({ id:'nns', name:'NASCAR Chevrolet Monte Carlo', maker:'Chevrolet', body:'stockcar',
  ...
  V({ id:'koenigsegg', name:'Koenigsegg Jesko', maker:'Koenigsegg', body:'super',
  ...
  V({ id:'concept', name:'Nissan Z Proto', maker:'Nissan', body:'coupe',
  ...
  V({ id:'bmw-m3-e46', name:'BMW M3 (E46)', maker:'BMW', body:'coupe', drivetrain:'RWD', bay:'front-longitudinal',
  ...
  V({ id:'bmw-m5', name:'BMW M5 (super saloon)', maker:'BMW', body:'sedan', drivetrain:'AWD', bay:'front-longitudinal',
  ...
  V({ id:'audi-r8', name:'Audi R8 V10', maker:'Audi', body:'super', drivetrain:'AWD', bay:'mid',
  ...
  V({ id:'audi-rs3', name:'Audi RS 3 (five-cylinder)', maker:'Audi', body:'hatch', drivetrain:'AWD', bay:'front-transverse',
  ...
  V({ id:'audi-quattro-s1', name:'Audi Quattro (Group B)', maker:'Audi', body:'rally', drivetrain:'AWD',
  ...
  V({ id:'maserati-mc20', name:'Maserati MC20', maker:'Maserati', body:'super', drivetrain:'RWD', bay:'mid',
      suspF:'doublewishbone', suspR:'doublewishbone', chassis:'carbon monocoque',
  ...
  V({ id:'maserati-granturismo', name:'Maserati GranTurismo', maker:'Maserati', body:'gt', drivetrain:'RWD',
  ...
  V({ id:'toyota-supra-a80', name:'Toyota Supra (A80)', maker:'Toyota', body:'coupe', drivetrain:'RWD',
      bay:'front-longitudinal', suspF:'doublewishbone', suspR:'doublewishbone',
  ...
  V({ id:'toyota-ae86', name:'Toyota Corolla (AE86)', maker:'Toyota', body:'coupe', drivetrain:'RWD',
  ...
  V({ id:'toyota-lfa', name:'Toyota LFA', maker:'Lexus', body:'gt', drivetrain:'RWD', bay:'front-longitudinal',
  ...
  V({ id:'toyota-gr-yaris', name:'Toyota GR Yaris', maker:'Toyota', body:'hatch', drivetrain:'AWD',
  ...
  V({ id:'ford-gt', name:'Ford GT', maker:'Ford', body:'super', drivetrain:'RWD', bay:'mid',
  ...
  V({ id:'ferrari-812', name:'Ferrari V12 Berlinetta', maker:'Ferrari', body:'gt', drivetrain:'RWD',
  ...
  V({ id:'porsche-911-gt3', name:'Porsche 911 GT3', maker:'Porsche', body:'coupe', drivetrain:'RWD', bay:'rear',
  ...
  V({ id:'nissan-gtr-r35', name:'Nissan GT-R (R35)', maker:'Nissan', body:'coupe', drivetrain:'AWD',
      bay:'front-longitudinal', suspF:'doublewishbone', suspR:'multilink',
  ...
  V({ id:'nissan-skyline-r34', name:'Nissan Skyline GT-R (R34)', maker:'Nissan', body:'coupe', drivetrain:'AWD',
  ...
  V({ id:'honda-nsx-na1', name:'Honda NSX (NA1)', maker:'Honda', body:'super', drivetrain:'RWD', bay:'mid',
  ...
  V({ id:'lambo-v12', name:'Lamborghini V12 Flagship', maker:'Lamborghini', body:'super', drivetrain:'AWD', bay:'mid',
      suspF:'pushrod', suspR:'pushrod', chassis:'carbon monocoque',
  ...
  V({ id:'bugatti-w16', name:'Bugatti W16 Hypercar', maker:'Bugatti', body:'hyper', drivetrain:'AWD', bay:'mid',
      suspF:'doublewishbone', suspR:'doublewishbone', chassis:'carbon monocoque',
  ...
  V({ id:'subaru-wrx-sti', name:'Subaru WRX STI', maker:'Subaru', body:'sedan', drivetrain:'AWD',
      bay:'front-longitudinal', suspF:'macpherson', suspR:'multilink',
  ...
  V({ id:'dragster', name:'Top-fuel dragster', maker:'Drag racing', body:'dragster', drivetrain:'RWD', bay:'mid',
  ...
  V({ id:'cruiser', name:'Softail cruiser', maker:'Cruiser', class:'bike', body:'cruiser', drivetrain:'belt',
  ...
  V({ id:'adv', name:'Honda Africa Twin', maker:'Honda', class:'bike', body:'adv', drivetrain:'shaft',
  ...
  V({ id:'mx', name:'Honda CRF450R', maker:'Honda', class:'bike', body:'mx', drivetrain:'chain',
  ...
  V({ id:'kart', name:'Shifter kart', maker:'Karting', class:'kart', body:'kart', drivetrain:'chain', bay:'side',
